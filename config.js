...
async function loadConfig() {
  try {
    colors.setTheme({
      ...
      (global.owner = [["6282372570201", "️Faruq - 𝑶𝒘𝒏𝒆𝒓", !0]]),
      (global.mods = ["6282372570201"]),
      (global.prems = ["6282372570201"]),
      (global.APIs = {
      ...
      (global.nomorbot = "6281310895595"),
      (global.nomorown = "6282372570201"),
      (global.namebot = " Faruq-ʙᴏᴛ あ⁩ "),
      (global.nameown = "「 Faruq 」"),
      ...
      (global.saweria = "https://saweria.com/Faruq"),
      (global.pulsa = "082195322106"),
      (global.trakteer = "https://trakteer.id/Faruq"),
      (global.paypal = "Faruq@mail.com"),
      ...
      (global.psaweria = "https://saweria.com/Faruq"),
      (global.rpg = {
        emoticon(string) {
...
function businessOwnerJid() {
  return pickRandom([
    pickRandom([global.nomorown, "0", "6282372570201"]) + "@s.whatsapp.net",
  ]);
}
